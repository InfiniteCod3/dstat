...
class EdgeFunctionsNodeBuilder extends EdgeFunctionsBuilder_1.default {
    ...
    getFunctionCode(srcPath) {
        ...
        return `const ${this.functionDefaultExportName} = require(${JSON.stringify((0, path_1.join)(this.baseDir, srcPath))}).handleHttpRequest;`;
    }
    /**
    ...
    async build(options = {}) {
        ...
        const bundledIndexCode = await this.bundleIndexCode(options.indexFilePath, (0, environment_1.isLocal)());
        const bytecode = await (0, EdgeFunctionCompiler_1.compileEdgeFunction)(bundledIndexCode, (0, paths_1.getBundlePath)());
