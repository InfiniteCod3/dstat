...
class EdgeFunctionsWorkerManager {
    constructor(context, rawBody, path, envVars, usrVars, httpVars) {
        this.readyResponses = [];
        ...
        const workerData = {
            ...
            params: new EdgeFunctionWorkerParams_1.default(context.getRequest(), rawBody, path, envVars, usrVars, httpVars, context.propertyContext.origins),
        };
    ...
    async issueFetch(requestId, ...fetchArgs) {
        ...
        if ((_c = (_b = options.fetchOrigin) === null || _b === void 0 ? void 0 : _b.tls_verify) === null || _c === void 0 ? void 0 : _c.allow_self_signed_certs) {
