...
const HTTP_HEADER_DELIMETER_BYTES = 4; // HTTP headers include ": \r\n" for each header
...
class EdgeFunction extends WasmProgram_1.default {
    ...
    async run() {
        ...
        // TODO: Response ID is returned by edge function context.respondWith(), the 2nd parameter should not be necessary
                        ...
                        if (this.params.envVars.has(name)) {
                            ...
                            if (typeof envVarValue !== 'string') {
                                return handleWasmError({
                                    ...
                                    message: `Dictionary value must be a string:  ${typeof envVarValue}`,
                                });
                            }
