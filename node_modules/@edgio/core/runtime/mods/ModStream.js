...
class ModStream extends Mod_1.default {
    ...
    applyStreamingConfig() {
        ...
        response.setIsStreamable(() => {
            ...
            const hintHeader = (_a = request.getHeader(constants_1.EDGIO_SERVERLESS_HINT_HEADER)) === null || _a === void 0 ? void 0 : _a.toString();
            // do not stream if we do proxy with transformRequest or transformResponse
            if (hintHeader === null || hintHeader === void 0 ? void 0 : hintHeader.includes(constants_1.EDGIO_SERVERLESS_HINTS.proxy)) {
                return false;
            }
