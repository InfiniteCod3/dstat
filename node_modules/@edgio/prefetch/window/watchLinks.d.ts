import CacheManifest from '@edgio/core/router/CacheManifest';
import { ObserveOptionsConfig } from './InstallOptions';
/**
 ...
 */
export default function watchLinks(cacheManifest: CacheManifest, observerOpts?: ObserveOptionsConfig): void;
