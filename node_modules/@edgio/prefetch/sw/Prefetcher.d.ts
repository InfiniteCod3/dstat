...
import { HTTPMethod } from '@edgio/core/constants';
import { OptionalNotValue } from '@edgio/core/router/CacheManifest';
...
export interface PrefetcherConfig {
    ...
    /**
     * Set to true to ignore requests that are not 'document' or 'empty' (ie: audio, font, image, ...).
     * This may help improve performance of sites when most assets are not cached.
     */
    skipAssets?: boolean;
}
