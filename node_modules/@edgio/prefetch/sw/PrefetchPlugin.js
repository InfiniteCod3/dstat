...
async function normalizeRequestUrlForCache(request, { cacheHost } = {}) {
    ...
    // remove edgio_prefetch, edgio_dt_pf and edgio_prefetch_ttl query params so that prefetches and real requests
...
class PrefetchPlugin {
     ...
     * compute cache stats and ensure that ?edgio_prefetch is removed from the cache key so
